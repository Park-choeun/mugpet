...
public interface CartMapper {
	...
	int getMyCartItemQty(@Param("item_id")int item_id, @Param("u_id")int u_id) throws DataAccessException;
	...
	Cart getMyCartItemCartType(@Param("item_id")int item_id, @Param("u_id")int u_id) throws DataAccessException;
	
	//Cart 목록에 item 추가하기
	void addCart(Cart cart) throws DataAccessException; 

	//Cart 목록에 item 정보 수정하기
	void updateCart(@Param("cartQty")int cartQty, @Param("item_id")int item_id, @Param("u_id")int u_id) throws DataAccessException; 

	//Cart 목록에 item 삭제하기
	void removeCart(@Param("item_id")int item_id, @Param("u_id")int u_id) throws DataAccessException; 	
