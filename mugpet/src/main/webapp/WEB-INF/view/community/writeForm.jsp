...
<div>
 ...
 <div style="width: 70%; padding: 30px; float: right;">
		    <form name="write" action="<c:url value='/community/insert' />" enctype="multipart/form-data" method="post">
  ...
  <br>
  <button type="submit" class="btn btn-danger" style="background-color: #FFD1FF; border-color: #FFD1FF;" type="submit" onClick="communityCreate()">등록</button>&nbsp;
